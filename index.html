...
<section class="wrapper bgded overlay" id="main">
  <div id="pageintro" class="hoc clear"> 
    <article>
      <p class="heading">Информационни технологии</p>
      <h1 class="heading"><span class="block" >Бъдещето е в </span> НАС !</h1>
      <footer><a href="#">Прочети повече &raquo;</a></footer>
    </article>
  </div>
</section>
<section class="wrapper row3" id="second-section">
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<section class="wrapper row3" id="third-section">
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<section class="wrapper bgded overlay" id="fourth-section">
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<section class="wrapper row3" id="fifth-section">
